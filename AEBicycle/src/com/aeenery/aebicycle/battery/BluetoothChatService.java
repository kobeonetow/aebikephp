...
//    private AcceptThread mAcceptThread;
    ...
    public static final int STATE_DISCONNECT = 1;     // now connection lost
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BicycleUtil.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
...
//        if (mAcceptThread != null) {mAcceptThread.cancel(); mAcceptThread = null;}
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BicycleUtil.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BicycleUtil.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BicycleUtil.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BicycleUtil.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
